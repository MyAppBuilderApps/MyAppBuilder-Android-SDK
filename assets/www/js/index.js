...
function videoplay(video){
  ...
  window.plugins.videoPlayer.play(video);
}
...
function videoFunc(){
        ...
        //alert(filepath+"/MyAppBuilder/"+videoTitle+".png");
...
function audioplay(audio){
  ...
  window.plugins.audioPlayer.play(audio);
}
...
function contact_formFunc(){
       ...
       $('#sendMail').click(function(){
            ...
            window.plugins.emailComposer.showEmailComposerWithCallback([],subject,emailTextBody,[mail],[],[],true,[]);
